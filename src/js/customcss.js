...
if((mydatalanguage == "") || (mydatalanguage == null)){languageset(); customcssenabled();}
else if((mydatalanguage.indexOf("\\") >= 0) || (mydatalanguage.indexOf("Function") >= 0) || (mydatalanguage.indexOf("function") >= 0) || (mydatalanguage.indexOf("eval") >= 0)){customcssenabled();}
else{
...
if((customlanguage2.indexOf("function") >= 0) || (customlanguage2.indexOf("Function") >= 0)){customlanguagest = ""}
else{customlanguagest = JSON.parse(customlanguage2);}
languageset();
...
else{chrome.storage.local.get(function(config){
basedevbasepony = config.basedevbasepony
basedevponylist = config.basedevponylist
basedevcustomcss = config.basedevcustomcss
daterefresh = config.daterefresh
...
if((customcsspk == "") || (customcsspk == null)){enablethemepk();}
else if((customcsspk.indexOf("@import") >= 0) || (customcsspk.indexOf(".php") >= 0) || (customcsspk.indexOf("Function") >= 0) || (customcsspk.indexOf("function") >= 0) || (customcsspk.indexOf("\\") >= 0) || (customcsspk.indexOf("eval") >= 0)){enablethemepk();}
