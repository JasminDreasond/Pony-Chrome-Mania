...
function viewsystempk(setconfigpk){chrome.storage.local.get(function(config){
...
if(basepony313[i].baseurl == "432pker23") {return;}
else{
...
if((sypkexdxx2.indexOf("http://") > 0) || (sypkexdxx2.indexOf("https://") > 0) || (sypkexdxx2.indexOf("ftp://") > 0) || (sypkexdxx2.indexOf("ftps://") > 0) || (sypkexdxx2.indexOf("file://") > 0)){var sypkexdxx = "Warn Box"}
else{var sypkexdxx = "Deviantart Box"}
}
...
if((optionclikedpk == false) && (loadnow == false)){$("#wariningnothing").removeClass("loadingwarningke");}
else if(loadnow == false){$("#wariningnothing").addClass("removewarningke").removeClass("loadingwarningke");}
else if(loadnow == true){$("#wariningnothing").removeClass("removewarningke").addClass("loadingwarningke").html($("<div>", {id: "imageloading"}));}
}
...
.replace(/source-base-JackieApkon\(href\)=\"/g, 'href="https://raw.githubusercontent.com/JackieApkon/Pony-Chrome-Mania/master/my_ponies/')
...
.replace(/source-base\(url\)/g, 'https://jackieapkon.github.io/Browser-Ponies/')
...
else{chrome.storage.local.get(function(config){chrome.storage.sync.get(function(settings){
ponylistcode = config.ponylisttext;
ponyverikep(ponylistcode, settings, config);
})})}
...
if($("#browserponies1t").val() == "nullts"){$("[id^='browserponies1t']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies2t").val() == "nullts"){$("[id^='browserponies2t']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies3t").val() == "nullts"){$("[id^='browserponies3t']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies4").val() == "nullts"){$("[id^='browserponies4']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies5").val() == "nullts"){$("[id^='browserponies5']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies6").val() == "nullts"){$("[id^='browserponies6']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies7").val() == "nullts"){$("[id^='browserponies7']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies8").val() == "nullts"){$("[id^='browserponies8']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies9").val() == "nullts"){$("[id^='browserponies9']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies10").val() == "nullts"){$("[id^='browserponies10']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies11").val() == "nullts"){$("[id^='browserponies11']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies12").val() == "nullts"){$("[id^='browserponies12']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies13").val() == "nullts"){$("[id^='browserponies13']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies14").val() == "nullts"){$("[id^='browserponies14']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies15").val() == "nullts"){$("[id^='browserponies15']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies16").val() == "nullts"){$("[id^='browserponies16']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies17").val() == "nullts"){$("[id^='browserponies17']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies18").val() == "nullts"){$("[id^='browserponies18']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies19").val() == "nullts"){$("[id^='browserponies19']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies20").val() == "nullts"){$("[id^='browserponies20']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies21").val() == "nullts"){$("[id^='browserponies21']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies22").val() == "nullts"){$("[id^='browserponies22']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies23").val() == "nullts"){$("[id^='browserponies23']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies24").val() == "nullts"){$("[id^='browserponies24']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies25").val() == "nullts"){$("[id^='browserponies25']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies26").val() == "nullts"){$("[id^='browserponies26']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies27").val() == "nullts"){$("[id^='browserponies27']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies28").val() == "nullts"){$("[id^='browserponies28']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies29").val() == "nullts"){$("[id^='browserponies29']").css({'display': 'none'}); numberaccount = numberaccount-1}
if($("#browserponies30").val() == "nullts"){$("[id^='browserponies30']").css({'display': 'none'}); numberaccount = numberaccount-1}

$("#numberaccountts").text(numberaccount);

chrome.storage.sync.get(function(settings) {if (settings.exdlenabled == null){
...
function checkurloptions(){setTimeout(function(){
if(geturlclickidurlfalse == "browserponies30urleditorskfalse"){}
else{
...
if(geturlclickidbasevisible == getthisvalueremover){detectsystemreload(thishere);}
else{$("[name='cliclremove']").removeClass("savedisabled").prop("disabled", false);}
},100)
...
if(this == geturlclickid2){errorloadsystem2(this);}
else if(poniesloaded == true){clickeditorponies(this); checkurloptions();}
...
if((ponyconfigpke.mycolorld1 == null) || (ponyconfigpke.mycolorld1 == "")){$("#ldcolorb").val("#48449d");} 
else{$("#ldcolorb").val(ponyconfigpke.mycolorld1);}
if((ponyconfigpke.mycolorld2 == null) || (ponyconfigpke.mycolorld2 == "")){$("#ldcolorp").val("#242424");} 
else{$("#ldcolorp").val(ponyconfigpke.mycolorld2);}
if((ponyconfigpke.mycolorld3 == null) || (ponyconfigpke.mycolorld3 == "")){$("#ldcolork").val("#ffffff");} 
else{$("#ldcolork").val(ponyconfigpke.mycolorld3);}
if((ponyconfigpke.mycolorld4 == null) || (ponyconfigpke.mycolorld4 == "")){$("#ldcolorc").val("#ffffff");} 
else{$("#ldcolorc").val(ponyconfigpke.mycolorld4);}
...
if(ponyconfigpke.loadingprogressponies == ""){$("input").prop("disabled", true); $("[name='commandponygenerator']").prop("disabled", false); alert("ERROR: loadingprogressponies = null");}
...
if(ponydetectstart == true){
setTimeout(function(){$("[name='count']").each(function(){	
...
if(!$(thisobject).val()){$("[id='selectionponyk'], #littletagslist").removeClass("hideponies");}
else{$("[id='selectionponyk']").addClass("hideponies"); $(searchthis).removeClass("hideponies"); $("#littletagslist").addClass("hideponies");}
}
...
setTimeout(function(){save_options_mycommand(); $("#saveponies").removeClass("savedisabled").removeAttr("disabled");},300)
}
else{
$("#saveponies").addClass("littlefailsave");
setTimeout(function(){$("#saveponies").removeClass("littlefailsave");},300)
...
if(optionclikedpk == true){$("#refreshwarncode").text("ON");}
else if(optionclikedpk == false){$("#refreshwarncode").text("OFF");}	
	
})

//Check options

function checkcodeoptions(){setTimeout(function(){
...
else if(($("#customlanguage").val() == "")){$("#customlanguage").removeClass("nothingitemcode")}
else{$("#customlanguage").removeClass("nothingitemcode2");}
...
function checkcodelanguagealt(){setTimeout(function(){
...
if((colorbkss > 6) && (colorbksh == "#")){$("#testcolorb").css({'background-color': colorbk});}
else{$("#testcolorb").css({'background-color': ''});}
if((colorpkss > 6) && (colorpksh == "#")){$("#testcolorp").css({'background-color': colorpk});}
else{$("#testcolorp").css({'background-color': ''});}
if((colorkkss > 6) && (colorkksh == "#")){$("#testcolorkc").css({'color': colorkk});}
else{$("#testcolorkc").css({'color': ''});}
if((colorckss > 6) && (colorcksh == "#")){$("#testcolorkc").css({'background-color': colorck});}
else{$("#testcolorkc").css({'background-color': ''});}
}



function checkoptionspagk(){setTimeout(function(){
...
if(($("#urlbase").val().startsWith("https://")) || ($("#urlbase").val().startsWith("http://"))){$("#globalbaseurlwarn").text("\u2714").addClass("warningglobalbase2");}
else{$("#globalbaseurlwarn").text("\u26a0").addClass("warningglobalbase1");}
...
if((colorbkss > 6) && (colorbksh == "#")){$("#ldcolorb").removeClass("nothingitemcode"); $("#progresscolor1").val(colorbk);}
else{$("#progresscolor1").val("#000000");}
if((colorpkss > 6) && (colorpksh == "#")){$("#ldcolorp").removeClass("nothingitemcode"); $("#progresscolor2").val(colorpk);}
else{$("#progresscolor2").val("#000000");}
if((colorkkss > 6) && (colorkksh == "#")){$("#ldcolork").removeClass("nothingitemcode"); $("#progresscolor3").val(colorkk);}
else{$("#progresscolor3").val("#000000");}
if((colorckss > 6) && (colorcksh == "#")){$("#ldcolorc").removeClass("nothingitemcode"); $("#progresscolor4").val(colorck);}
...
function checkoptionspagk2(){setTimeout(function(){
...
$("#ldcolorb, #ldcolorp, #ldcolork, #ldcolorc, #progressbar").bind("mouseover keypress keydown keyup click", function(){checkoptionspagk(); generatorjavaconfk(false);})
...
$("#ldcolork").val("#ffffff");
$("#ldcolorc").val("#ffffff");
checkoptionspagk(); generatorjavaconfk(false);
setprogresscolorex();
})