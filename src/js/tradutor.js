...
function languageset(){chrome.storage.sync.get(function(settings) {
...
if($(location).attr('href').indexOf('https://jackieapkon.github.io/Browser-Ponies/') > -1){
...
if((specialpagesource == true) || (customlanguagest == "") || (customlanguagest == null)){}
else{
...
if (typeof customlanguagest.translationcopyright !== "undefined"){ $("#extracopyright2").text(customlanguagest.translationcopyright); $("#englishtranslation").addClass("hideenglishcr");}
...
if($(location).attr('href').indexOf('https://jackieapkon.github.io/Browser-Ponies/') > -1){} 
else{$("#laguageoptions").change(function(){languageaction();});}

if($(location).attr('href') == 'https://jackieapkon.github.io/Browser-Ponies/'){} 
else{languageset();}