function systemupdate(updateset, resultfinalpk) {
    chrome.storage.sync.get(function(settings) {
        ...
        function setsavepk(savehere) {
            ...
            function saveallpke(devsetpke, reloadtrue) {
                ...
                if (savehere.saveType == "basepony") {
                    ...
                    if ((savehere.save.startsWith('"')) && (savehere.save.endsWith('"'))) {} else { savehere.save = '"' + savehere.save + '"' }
            ...
            function securityverkxs(setsecurity) {
                chrome.storage.local.get(function(config) {
                    ...
                    if (setsecurity.next == true) {
                        ...
                        if (savehere.saveType == "basepony") {
                            if ((updateset.checksecurity == true) || (config.basedevbasepony == true)) { checkpkexs(setsecurity.baseval); } else { saveallpke(setsecurity.baseval); }
                        } else if (savehere.saveType == "ponylist") {
                            if ((updateset.checksecurity == true) || (config.basedevponylist == true)) { checkpkexs(setsecurity.baseval); } else { saveallpke(setsecurity.baseval); }
                        } else if (savehere.saveType == "customcss") {
                            if ((updateset.checksecurity == true) || (config.basedevcustomcss == true)) { checkpkexs(setsecurity.baseval); } else { saveallpke(setsecurity.baseval); }
                        }
                ...
                if ((pkesele.url.endsWith(pkesele.format)) || (pkesele.url.startsWith("https://googledrive.com/host/")) || (pkesele.url.startsWith("http://sonicrainboom.com.br/attachment.php?aid=")) || (pkesele.url.startsWith("https://sonicrainboom.com.br/attachment.php?aid="))) {
                    $.ajax({
                        ...
                        error: function(XMLHttpRequest, textStatus, errorThrown) {
                            ...
                            if (XMLHttpRequest.readyState == 4) { var myerrorof = myerrorof + " - readyState4"; } else if (XMLHttpRequest.readyState == 0) { var myerrorof = myerrorof + " - readyState0"; } else { var myerrorof = myerrorof + " - readyState?" }
                        ...
                        success: function(data) {
                            if ((data.indexOf("Function") > 0) || (data.indexOf("function") > 0) || (data.indexOf("eval") > 0) || (data.indexOf("\\u0046\\u0055\\u004e\\u0043\\u0054\\u0049\\u004f\\u004e") > 0) || (data.indexOf("\\u0066\\u0075\\u006e\\u0063\\u0074\\u0069\\u006f\\u006e") > 0) || (data.indexOf("\\u0045\\u0056\\u0041\\u004c") > 0) || (data.indexOf("\\u0065\\u0076\\u0061\\u006c") > 0) || (data.indexOf(".php") >= 0) || (data.indexOf(".html") >= 0) || (data.indexOf(".asp") >= 0)) {
                                setsavepk({
                                    "saveType": pkesele.saveType,
                                    "save": null,
                                    "url": null,
        ...
        function finishsystempker() {
            ...
            if (updateset.globalStart == true) {
                chrome.storage.local.get(function(settings2) {
                    if (baseponytext == null) {} else { settings2.baseponytext = baseponytext }
                    if (interactionstext == null) {} else { settings2.interactionstext = interactionstext }
                    if (ponylisttext == null) {} else { settings2.ponylisttext = ponylisttext }
                    if (customcsstext == null) {} else { settings2.customcsstext = customcsstext }
                    if (customlanguagetext == null) {} else { settings2.customlanguagetext = customlanguagetext }
                    if (customcssurl == null) {} else { settings2.customcssurl = customcssurl }
                    if (basedevbasepony == null) {} else { settings2.basedevbasepony = basedevbasepony }
                    if (basedevponylist == null) {} else { settings2.basedevponylist = basedevponylist }
                    if (basedevcustomcss == null) {} else { settings2.basedevcustomcss = basedevcustomcss }
                    if (basedevcustomcss == null) {} else { settings2.daterefresh = daterefresh }
                    resultfinalpk(settings, settings2);
                })
            } else if (updateset.localStart == true) {
                chrome.storage.local.get(function(settings2) {
                    if (baseponytext == null) {} else { settings2.baseponytext = baseponytext }
                    if (interactionstext == null) {} else { settings2.interactionstext = interactionstext }
                    if (ponylisttext == null) {} else { settings2.ponylisttext = ponylisttext }
            ...
            } else if (updateset.syncStart == true) {
                chrome.storage.local.get(function(settings2) {
        ...
        function saveDatepkee() {
            if ((updateset.basepony == true) || (updateset.interactions == true) || (updateset.ponylist == true) || (updateset.customcss == true) || (updateset.customlanguage == true)) {
                var tehd = new Date();
