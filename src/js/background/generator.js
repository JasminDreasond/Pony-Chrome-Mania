...
function updatelanguagecontmenu() {
    chrome.storage.sync.get(function(settings) {
        ...
        chrome.storage.local.get(function(config) {
            ...
            if ((config.customlanguagetext == "") || (config.customlanguagetext == null)) { nothinglanguagepkr(); } else {
...
function updatesystempker(settings) {
    if (settings.refreshautoconfig == true) {
        systemupdate({
            "basepony": true,
            "interactions": true,
            "customlanguage": true
...
function privacycheckpek(settings) {
    chrome.storage.local.get(function(config) {
